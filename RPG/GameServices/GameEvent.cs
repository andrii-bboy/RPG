...
namespace RPG.GameServices
{
    public class GameEvent
    {
        ...
        public static List<GameEvent> GenerateEvents()
        {
            ...
            {
                new GameEvent("You found and drank a normal healing potion. (+15 HP)", p => p.HP.increase(15)),
                new GameEvent("You found and drank a strong healing potion. (+30 HP)", p => p.HP.increase(30)),
                ...
                new GameEvent("You found and drank a weak healing potion. (+7 HP)", p => p.HP.increase(7)),
